...
/*----------------------------------------------------------------------------*/
/* Execution flag */
#define HVC_ACTIV_BODY_DETECTION        0x00000001		//人体検出
//#define HVC_ACTIV_HAND_DETECTION        0x00000002	//手検出
#define HVC_ACTIV_HAND_DETECTION        0x00000000
#define HVC_ACTIV_FACE_DETECTION        0x00000004		//顔検出
#define HVC_ACTIV_FACE_DIRECTION        0x00000008		//顔向き推定
#define HVC_ACTIV_AGE_ESTIMATION        0x00000010		//年齢推定
#define HVC_ACTIV_GENDER_ESTIMATION     0x00000020		//性別推定
#define HVC_ACTIV_GAZE_ESTIMATION       0x00000040		//視線推定
//#define HVC_ACTIV_BLINK_ESTIMATION      0x00000080	//目瞑り推定
#define HVC_ACTIV_BLINK_ESTIMATION      0x00000000
#define HVC_ACTIV_EXPRESSION_ESTIMATION 0x00000100		//表情推定
//#define HVC_ACTIV_FACE_RECOGNITION      0x00000200		//顔認証
#define HVC_ACTIV_FACE_RECOGNITION      0x00000000
...
/*----------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------*/
/* Device’s model and version info                                           */
/*----------------------------------------------------------------------------*/
typedef struct {
    UINT8   string[12];
    UINT8   major;
